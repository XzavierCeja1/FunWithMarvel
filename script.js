...
//
//
// let ironMan = `Rotten Tomatoes = ${movieIronMan["rottenTomatoes"]}`
//
// console.log(ironMan)
//
// $('#display-area').append(ironMan)
//
// let ironMan1 = `Budget = ${movieIronMan["budget"]}`
//
// console.log(ironMan1)
//
// $('#display-area').append(ironMan1)
//
// let ironMan2 = `Discription of Iron Man = ${movieIronMan["description"]}`
//
// console.log(ironMan2)
//
// $('#display-area').append(ironMan2)
...
for (var i=0; i < movieListDetailed.length;i++){
  let movieObject = movieListDetailed[i]
  console.log(movieObject["title"])

  let titleElement = `<h1>${movieObject["title"]}</h1>`
  $('#display-area').append(titleElement)
